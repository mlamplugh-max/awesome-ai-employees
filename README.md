...
- [Orkas](https://github.com/Orkas-AI/Orkas) - Local-first desktop app where a commander coordinates specialist agents and installed coding CLIs under user approvals.
